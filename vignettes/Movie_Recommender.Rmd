...
output:
  ...
  rmarkdown::html_vignette:
    fig_width: 10
    fig_height: 8
description: Analyzing and visualizing the movies data and recommend the movies to
  users based on their historical data.
vignette: >
  %\VignetteIndexEntry{opt}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
  "%\\VignetteIndexEntry{Movie_Recommender}                 
  %\\VignetteEngine{knitr::rmarkdown}
  %\\VignetteEncoding{UTF-8}\n"
---
